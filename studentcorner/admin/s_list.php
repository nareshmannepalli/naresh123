...
<td>
<a href="profile.php?studid=<?php echo $fetch['stud_id']?>">view</a></td>

<td>
<form name="" action="student/edit.php" method="post">
...
<input type="hidden" name="stud_id" value="<?php echo $fetch['stud_id']?>"> 
<input type="submit" name="delete" value="delete"></td></form></tr>
<?php
}
?>
 </tbody>
