...
<form name="sub"class="form-validate form-horizontal"  method="post" action="subjectvalues.php">
                            
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">subject<span class="required"></span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cemail" type="text" name="subject" value="" required />
                                          </div>
                                      </div>
...
$sql="select * from subject_table details";
...
<td><form name="" action="subjectform.php" method="post">
<input type="hidden" name="id1" value="<?php echo $fetch['subject_id']?>">
</td></form >
<td>
</form>
</tr>
