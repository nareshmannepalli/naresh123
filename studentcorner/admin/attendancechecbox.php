                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">                          
                            <form name="" action="attendancevalues.php" method="post">   
...
$sql="select * from student_details where dept_id='$_POST[Deportement]' and section='$_POST[section]'";
$_SESSION['Deportement']=$_POST['Deportement'];
...
$i=1;
                                   ...
                                   while($fetch=mysql_fetch_array($query)) { ?>
                                             ...
                                             <td><?php echo $fetch['rollno']?></td>
                                              <td><input type="hidden" name="rollno<?php echo $i;?>" value="<?php echo $fetch['rollno']?>"></td>
                                             <td> <input type="checkbox" name="present<?php echo $i;?>[]" value="present">present</td>
