...
echo $sql='select * from `student_details` where stud_id="'.$_POST['stud_id'].'"';
...
?>
<html>
<body style="background:url(flowers-cherry-petals-buds-macro-purple-background-photo.jpg) no-repeat">
