...
$sql="select suggestion_table.*,student_details.* from suggestion_table LEFT JOIN student_details on suggestion_table.stud_rollno=student_details.rollno where suggestion_id='$_POST[id1]'";
 $_SESSION['id2']=$_POST['id1'];
$query=mysql_query($sql);

$fetch=mysql_fetch_array($query);
?>
                              <form class="form-horizontal " method="post" action="suggestionupdate.php">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Suggestion Id</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="suggestion_id" value="<?php echo $fetch['suggestion_id'];?>">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Student Name</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="stud_name" value="<?php echo $fetch['stud_name'];?>">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control round-input" name="message" value="<?php echo $fetch['message'];?>">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Message Date</label>
                                      <div class="col-sm-10">
                                          <input class="form-control" id="focusedInput" name="message_date" type="text" value="<?php echo $fetch['message_date'];?>">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Status</label>
                                      <div class="col-sm-10">
                                          <input class="form-control" id="focusedInput" name="Status" type="text" value="<?php echo $fetch['Status']?>">
                                      </div>
                                  </div>
                                  <div class="form-group">
